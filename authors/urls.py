...
urlpatterns = [
    ...
    path("dashboard/delete/", views.DashboardRecipeDelete.as_view(), name="dashboard_recipe_delete"),
    path("dashboard/<int:id>/edit/", views.DashboardRecipe.as_view(), name="dashboard_recipe_edit"),
